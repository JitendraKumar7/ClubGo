 ...
 */
public class AroundTownAdapter extends RecyclerView.Adapter<AroundTownAdapter.CustomViewHolder> {
    ...
    public AroundTownAdapter(Context context, List<ModalHome> mDataList) {
