 ...
 */
public class VenueFoodAdapter extends RecyclerView.Adapter<VenueFoodAdapter.CustomViewHolder> {

    private Context context;
    private List<String> mImage;
    private static MyClickListener myClickListener;

    public VenueFoodAdapter(Context context, List<String> mImage) {
