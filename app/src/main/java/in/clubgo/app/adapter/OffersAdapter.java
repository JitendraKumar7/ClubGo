...
public class OffersAdapter extends RecyclerView.Adapter<OffersAdapter.CustomViewHolder> {
    ...
    public OffersAdapter(Context context, List<ModalHome> mDataList) {
    ...
    public void onBindViewHolder(CustomViewHolder holder, int position) {
        holder.tvTitle.setText(mDataList.get(position).getPlace());
        holder.tvOffers.setText(mDataList.get(position).getTitle());
