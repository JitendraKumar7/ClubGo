 ...
 */
public class HotspotsAdapter extends RecyclerView.Adapter<HotspotsAdapter.CustomViewHolder> {
    ...
    public HotspotsAdapter(Context context, List<ModalHome> mDataList) {
